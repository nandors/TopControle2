              ...
              <v-layout wrap>
                ...
                <v-flex xs12 sm4 md4>
                  <v-text-field
                    name='txtcontratados'
                    label='contratados'
                    :rules="[ v => !!v || 'contratados requerido']"
                    id='txtcontratados'
                    type='text'
                    v-model='newRegistro.contratados'
                    required></v-text-field>
                </v-flex>
      ...
      <v-card>
        ...
        <v-data-table
          ...
          <template slot="items" slot-scope="props">
              ...
              <td class='text-xs-left'>{{ props.item.contratados }}</td>
    ...
    data: function () {
      return {
        headers: [
          ...
          { text: 'contratados', align: 'left', value: 'contratados' },
