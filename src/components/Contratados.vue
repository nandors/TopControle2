              ...
              <v-layout wrap>
                ...
                <v-flex xs12 sm4 md4>
                  <v-text-field
                    name='txtend'
                    label='end'
                    :rules="[ v => !!v || 'end requerido']"
                    id='txtend'
                    type='text'
                    v-model='newRegistro.end'
                    required></v-text-field>
                </v-flex>
                ...
                <v-flex xs12 sm4 md4>
                  <v-text-field
                    name='txttel'
                    label='tel'
                    :rules="[ v => !!v || 'tel requerido']"
                    id='txttel'
                    type='text'
                    v-model='newRegistro.tel'
                    required></v-text-field>
                </v-flex>
                ...
                <v-flex xs12 sm4 md4>
                  <v-text-field
                    name='txtobservacao'
                    label='observacao'
                    :rules="[ v => !!v || 'observacao requerido']"
                    id='txtobservacao'
                    type='text'
                    v-model='newRegistro.observacao'
                    required></v-text-field>
                </v-flex>
    ...
    data: function () {
      return {
        headers: [
          ...
          { text: 'observacao', align: 'left', value: 'observacao' }
        ],
        newRegistro: {
          codigo: '',
          nome: '',
