              ...
              <v-layout wrap>
                ...
                <v-flex xs12 sm4 md4>
                  <v-text-field
                    name='txtpreco'
                    label='preco'
                    :rules="[ v => !!v || 'preco requerido']"
                    id='txtpreco'
                    type='text'
                    v-model='newRegistro.preco'
                    required></v-text-field>
                </v-flex>
                ...
                <v-flex xs12 sm4 md4>
                  <v-text-field
                    name='txtcusto'
                    label='custo'
                    :rules="[ v => !!v || 'custo requerido']"
                    id='txtcusto'
                    type='text'
                    v-model='newRegistro.custo'
                    required></v-text-field>
                </v-flex>
      ...
      <v-card>
        ...
        <v-data-table
          ...
          <template slot="items" slot-scope="props">
              ...
              <td class='text-xs-left'>{{ props.item.custo }}</td>
    ...
    data: function () {
      return {
        headers: [
          ...
          { text: 'preco', align: 'left', value: 'preco' },
          { text: 'tipo', align: 'left', value: 'tipo' },
          { text: 'custo', align: 'left', value: 'custo' }
        ],
        newRegistro: {
          codigo: '',
          descricao: '',
