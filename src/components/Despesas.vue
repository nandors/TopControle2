              ...
              <v-layout wrap>
                ...
                <v-flex xs12 sm4 md4>
                  <v-text-field
                    name='txttipodespesa'
                    label='tipodespesa'
                    :rules="[ v => !!v || 'tipodespesa requerido']"
                    id='txttipodespesa'
                    type='text'
                    v-model='newRegistro.tipodespesa'
                    required></v-text-field>
                </v-flex>
                ...
                <v-flex xs12 sm4 md4>
                  <v-text-field
                    name='txtlojas'
                    label='lojas'
                    :rules="[ v => !!v || 'lojas requerido']"
                    id='txtlojas'
                    type='text'
                    v-model='newRegistro.lojas'
                    required></v-text-field>
                </v-flex>
      ...
      <v-card>
        ...
        <v-data-table
          ...
          <template slot="items" slot-scope="props">
              ...
              <td class='text-xs-left'>{{ props.item.lojas }}</td>
    ...
    data: function () {
      return {
        headers: [
          ...
          { text: 'tipodespesa', align: 'left', value: 'tipodespesa' },
          ...
          { text: 'lojas', align: 'left', value: 'lojas' }
        ],
        newRegistro: {
          codigo: '',
          tipodespesa: '',
